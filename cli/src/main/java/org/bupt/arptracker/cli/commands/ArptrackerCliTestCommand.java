 ...
 */
package org.bupt.arptracker.cli.commands;
...
public class ArptrackerCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ArptrackerCliTestCommand.class);
    protected final ArptrackerCliCommands service;

    public ArptrackerCliTestCommand(final ArptrackerCliCommands service) {
